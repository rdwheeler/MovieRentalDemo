...
namespace ProductService.AppCore.UseCases.Queries
{
    public class GetProducts
    {
        public class Query : IListQuery<ListResultModel<ProductDto>>
        {
            ...
            internal class Handler : IRequestHandler<Query, Commerce.Core.Domain.ResultModel<ListResultModel<ProductDto>>>
            {
                ...
                public async Task<Commerce.Core.Domain.ResultModel<ListResultModel<ProductDto>>> Handle(Query request,
                    CancellationToken cancellationToken)
                {
                    ...
                    return Commerce.Core.Domain.ResultModel<ListResultModel<ProductDto>>.Create(resultModel);
                }
            }
        }
    }
